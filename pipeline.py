...
def parse_arguments():
    ...
    parser.add_argument("--format", "-f", default="csv", choices=["csv", "json"], required=False, help="Output format")
...
def validate_input(filepath):
    ...
    if Path(filepath).is_file():
        logging.info("Input file validated: " + filepath)
        return True
    else:
        logging.error("Input file not found: " + filepath)
        return False
...
def main():
    ...
    logging.debug("Arguments parsed: " + str(args))
